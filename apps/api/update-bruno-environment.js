...
`;
    ...
    try {
        ...
        console.log(`✅ Bruno Production environment updated with API URL: ${cleanApiUrl}`);
        console.log(`📁 Environment file: ${productionEnvPath}`);
        console.log(`💡 Switch to 'Production' environment in Bruno to test the deployed API`);
        return true;
    } catch (error) {
