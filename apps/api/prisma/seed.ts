...
async function main() {
  ...
  const actors = await Promise.all([
    prisma.actor.create({
      data: {
        ...
        description: 'Academy Award-winning actor known for environmental activism',
        biography: 'American actor and film producer known for his work in biographical and period films. He has received numerous accolades, including an Academy Award, a British Academy Film Award, and three Golden Globe Awards. Known for his environmental activism.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'French actress, singer, and environmentalist. She is known for her wide range of roles across independent films and blockbusters. She won the Academy Award for Best Actress for her portrayal of Édith Piaf in La Vie en Rose.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        nationality: 'British',
        description: 'Versatile English actor known for intense transformations',
        biography: 'English actor and producer known for his versatile roles and physical transformations. He has appeared in films such as Inception, The Dark Knight Rises, Mad Max: Fury Road, and Venom.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'Irish actor known for his work in both independent and blockbuster films. He is best known for playing Thomas Shelby in the BBC series Peaky Blinders and for his collaborations with director Christopher Nolan.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        nationality: 'American',
        description: 'Legendary actor with distinctive voice and commanding presence',
        biography: 'American actor, director, and narrator known for his distinctive deep voice and various roles in a wide variety of film genres. He has received multiple accolades, including an Academy Award, a Screen Actors Guild Award, and a Golden Globe Award.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'American actor, director, and musician. He is known for his roles in films such as The Shawshank Redemption, Mystic River, and Dead Man Walking. He has won an Academy Award and two Golden Globe Awards.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        nationality: 'American',
        description: 'Versatile actress known for both indie and blockbuster films',
        biography: 'American actress and singer. She was the world\'s highest-paid actress in 2018 and 2019, and has featured multiple times on the Forbes Celebrity 100 list. She is known for her roles in Lost in Translation, The Avengers series, and Marriage Story.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'English actor known for his intense method acting style and radical physical transformations for his roles. He has received numerous accolades, including an Academy Award and two Golden Globe Awards. Known for The Dark Knight trilogy and The Machinist.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'Israeli-born American actress and director. She has won an Academy Award, a British Academy Film Award, and two Golden Globe Awards. Known for her roles in Black Swan, V for Vendetta, and the Star Wars prequel trilogy.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'New Zealand-born Australian actor, director, musician, and singer. He came to international attention for his role as Maximus Decimus Meridius in the historical epic film Gladiator, for which he won an Academy Award for Best Actor.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        nationality: 'British',
        description: 'Acclaimed British actress known for dramatic performances',
        biography: 'English actress known for her work in independent films, particularly period dramas. She has won an Academy Award, a Grammy Award, two Primetime Emmy Awards, and multiple BAFTA and Golden Globe Awards. Best known for Titanic and The Reader.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'American actor and producer. His career has been characterized by critical and popular success in his youth, followed by a period of substance abuse and legal troubles, before a resurgence of commercial success later in his career.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        nationality: 'American',
        description: 'Intense method actor known for psychologically complex roles',
        biography: 'American actor, producer, and animal rights activist. He has received numerous accolades, including an Academy Award, a British Academy Film Award, a Grammy Award, and two Golden Globe Awards. Known for Joker, Her, and Walk the Line.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        nationality: 'American',
        description: 'Versatile actress known for both comedic and dramatic roles',
        biography: 'American actress known for both her comedic and dramatic performances. She has been featured three times in annual rankings of the highest-paid actresses in the world. She has received various accolades, including two Golden Globe Awards.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'American actor, film producer, and screenwriter. He is ranked among Forbes magazine\'s most bankable stars and is one of the highest-grossing actors of all time. He won an Academy Award for Best Original Screenplay for Good Will Hunting.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        nationality: 'American',
        description: 'Versatile actress known for dramatic and musical performances',
        biography: 'American actress. She is the recipient of various accolades, including an Academy Award, a Golden Globe Award, and a Primetime Emmy Award. She was one of the highest-paid actresses in the world in 2015.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'English actor. Known for his distinctive cockney accent, he has appeared in more than 130 films in a career spanning seven decades. He is ranked 20th on the list of highest-grossing box office stars.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'South African and American actress and producer. One of the world\'s highest-paid actresses, she is the recipient of various accolades, including an Academy Award, a Screen Actors Guild Award, and a Golden Globe Award.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'Welsh actor, director, and producer. He has received many accolades, including two Academy Awards, four BAFTAs, two Emmys, and the Cecil B. DeMille Award. He is best known for his portrayal of Hannibal Lecter in The Silence of the Lambs.',
      },
    }),
    prisma.actor.create({
      data: {
        ...
        biography: 'American actress, director, and producer. She has received two Academy Awards, three British Academy Film Awards, two Golden Globe Awards, and the Cecil B. DeMille Award. She is known for The Silence of the Lambs and Taxi Driver.',
      },
    }),
  ]);
  ...
  console.log(`🎭 Created ${actors.length + 3} actors (20 main actors + 3 test actors)`);
